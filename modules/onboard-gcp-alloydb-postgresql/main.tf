...
module "gcp-alloydb-postgresql-asset" {
  ...
  asset_display_name = var.read_pool_instance_id
  asset_id           = "projects/${var.cluster_project}/locations/${var.cluster_location}/clusters/${var.cluster_id}/instances/${var.read_pool_instance_id}"
  audit_pull_enabled = var.gcp_alloydb_postgresql_cluster_audit_pull_enabled
  cluster_id         = var.cluster_id
