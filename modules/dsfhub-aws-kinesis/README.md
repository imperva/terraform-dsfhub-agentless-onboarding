...
| <a name="input_asset_id"></a> [asset\_id](#input\_asset\_id) | AWS kinesis stream ARN | `string` | n/a | yes |
...
| <a name="input_region"></a> [region](#input\_region) | AWS region of the kinesis stream | `string` | `null` | no |

## Outputs

| Name | Description |
|------|-------------|
| <a name="output_this"></a> [this](#output\_this) | AWS Kinesis asset |
<!-- END_TF_DOCS -->