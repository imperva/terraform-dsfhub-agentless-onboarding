# onboard-aws-rds-aurora-postgresql-kinesis
...
| <a name="input_cluster_id"></a> [cluster\_id](#input\_cluster\_id) | The name of the Aurora PostgreSQL cluster | `string` | n/a | yes |
