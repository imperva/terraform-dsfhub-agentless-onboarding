...
variable "asset_id" {
  description = "The Azure resource ID of the Azure CosmosDB Table account."
  type        = string
}
...
variable "server_host_name" {
  description = "Azure CosmosDB Table account endpoint."
  type        = string
}

variable "server_port" {
  description = "Azure CosmosDB Table account port. Defaults to 443."
  type        = string
  default     = "443"
}
