...
| <a name="input_azure_eventhub_application_id"></a> [azure\_eventhub\_application\_id](#input\_azure\_eventhub\_application\_id) | Also referred to as the Client ID this is the unique identifier for the registered application being used to execute Python SDK commands against Azure’s API services. You can find this number under Azure Active Directory -> App Registrations -> Owned Applications. | `string` | `null` | no |
| <a name="input_azure_eventhub_auth_mechanism"></a> [azure\_eventhub\_auth\_mechanism](#input\_azure\_eventhub\_auth\_mechanism) | Specifies the auth mechanism used by the connection. Possible values are: default, client\_secret, or azure\_ad. Defaults to default. | `string` | `"default"` | no |
| <a name="input_azure_eventhub_client_secret"></a> [azure\_eventhub\_client\_secret](#input\_azure\_eventhub\_client\_secret) | This a string containing a secret used by the application to prove its identity when requesting a token. You can get a secret by going to Azure Active Directory -> App Registrations -> Owned Applications, selecting the desired application and then going to Certificates & secrets -> Client secrets -> + New client secret | `string` | `null` | no |
| <a name="input_azure_eventhub_directory_id"></a> [azure\_eventhub\_directory\_id](#input\_azure\_eventhub\_directory\_id) | Also referred to as the Tenant ID and is a GUID representing the Active Directory Tenant. It can be found in the Azure Active Directory page under the Azure portal | `string` | `null` | no |
| <a name="input_azure_eventhub_format"></a> [azure\_eventhub\_format](#input\_azure\_eventhub\_format) | The type of audit data being sent to the Event Hub. Possible values are: AzureSQL\_Managed, Blob, Cosmos\_Mongo, Cosmos\_SQL, Cosmos\_Table, Data\_Explorer, Databricks\_Workspace, File, Mariadb, Mysql, Mysql\_Flexible, Postgresql, Postgresql\_Flexible, Queue, Sql, Synapse, Table. Defaults to Sql. | `string` | `"Sql"` | no |
...
| <a name="input_azure_eventhub_subscription_id"></a> [azure\_eventhub\_subscription\_id](#input\_azure\_eventhub\_subscription\_id) | This is the Azure account subscription ID. You can find this number under the Subscriptions page on the Azure portal. Required when using client\_secret auth mechanism. | `string` | `null` | no |
| <a name="input_azure_eventhub_user_identity_client_id"></a> [azure\_eventhub\_user\_identity\_client\_id](#input\_azure\_eventhub\_user\_identity\_client\_id) | The client ID of a user-assigned managed identity. Defaults to the value of the environment variable AZURE\_CLIENT\_ID, if any. If not specified, a system-assigned identity will be used. | `string` | `null` | no |
