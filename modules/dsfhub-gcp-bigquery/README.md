...
| <a name="input_duration_threshold"></a> [duration\_threshold](#input\_duration\_threshold) | How long (in milliseconds) a query's execution may take until it is flagged as slow. | `number` | `null` | no |
